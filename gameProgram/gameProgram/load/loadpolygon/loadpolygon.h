//*****************************************************************************
//
// スレッド用ポリゴン [loadpolygon.h]
// Author : MAI TANABE
//
//*****************************************************************************

#ifndef LOAD_POLYGON_H_
#define LOAD_POLYGON_H_
//=============================================================================
...
public:
	...
	LoadPolygon(void);
	virtual ~LoadPolygon(void);

	static bool Create(LoadPolygon** outPointer, LPDIRECT3DDEVICE9 device , LPDIRECT3DTEXTURE9 textue , D3DXVECTOR3 polygonSize );
	bool Initialize(LPDIRECT3DDEVICE9 device , LPDIRECT3DTEXTURE9 texture , D3DXVECTOR3 polygonSize );
	void Finalize(void);
	void Update(void);
